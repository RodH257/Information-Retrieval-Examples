...
namespace RodHowarthAssignment1.Question23
{
    ...
    /**
      * French version of the C# Porter Stemmer Implementation
     * http://tartarus.org/~martin/PorterStemmer/
      */
    [ClassInterface(ClassInterfaceType.None)]
    public class FrenchStemmer : StemmerInterface
    {
        ...
        */
        ...
        /* step1() gets rid of plurals 
         * 
        * hâtaient > hâtai
         * dirigeaient > dirigeai
         * les > le
         * huguenots > huguenot
         * Plusieurs > Plusieur
         * bourgeois > bourgeoi
         * fréquentes > fréquente
         * archives > archive
         * guerroyaient > guerroyai
         * faisaient  > faisai
         * s'armaient > s'armai
         * précipitèrent  > précipitèr
        */
        public void Step1()
        {
